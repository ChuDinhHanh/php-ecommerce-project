...
//so trang
$numberOfPage =  ceil(($qtyCategory) / $accountPerpage);
if ($pageNow < 1) {
...
$offset = (($pageNow - 1)  * $accountPerpage);

// //day san pham tren 1 trang
$accountListPerpage  = $account->getAccountPage($accountPerpage, $offset);

if (isset($_GET['idAO'])) {
    $idA = $_GET['idAO'];
    $account->lockAccount(0,$idA);
    header("location:account_manager_admin.php");
}

if (isset($_GET['idAL'])){
    $idA = $_GET['idAL'];
    $account->lockAccount(1,$idA);
    header("location:account_manager_admin.php");
}
    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                <a href="account_manager_admin.html" class="navbar-brand d-flex d-lg-none me-4">
                ...
                <div class="bg-light text-center rounded p-4">
                    ...
                    <div class="table-responsive">
                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                <?php
                                foreach ($accountListPerpage  as $account) {
                                ?>
                                    <tr>
                                        ...
                                        <td style="display: flex;justify-content: space-around;">
                                            <?php if ($account['status'] == 0) { ?>
                                                <a href="account_manager_admin.php?idAL=<?php echo $account['id']; ?>"><i class="fa-solid fa-lock"></i></i></a>
                                            <?php } ?>
                                            <?php if ($account['status'] == 1) { ?>
                                                <a href="account_manager_admin.php?idAO=<?php echo $account['id']; ?>"><i class="fa-solid fa-lock-open"></i></i></i></a>
                                            <?php } ?>
                                        </td>
                                    </tr>
                                <?php
            ...
            <div style="display: flex; justify-content: center; align-items: center; margin-bottom: 10px;" id="container_page_area">
                <div class="product__pagination">
                    ...
                    ?>
                        ...
                        if ($pageNow > 2) {
                        ?>
                            <a class="num" style="background-color: #F3F6FA;" href="account_manager_admin.php?pageNow=1">First</a>
                        <?php
                        }
                        ?>
                        <a class="num" style="background-color: #F3F6FA;" href="account_manager_admin.php?pageNow=<?php echo ($pageNow - 1); ?>">
                            &lt; </a>
                        ...
                        ?>
                            ...
                            ?>
                                ...
                                ?>
                                    <a class="num" style="background-color: #F3F6FA;" href="account_manager_admin.php?pageNow=<?php echo $i; ?>"><?php echo $i; ?></a>
                                <?php
                                }
                                ?>
                            <?php
                        ...
                        ?>
                        <a class="num" style="background-color: #F3F6FA;" href="account_manager_admin.php?pageNow=<?php echo ($pageNow + 1); ?>"> &gt;</a>
                        <?php
                        if ($pageNow <= $numberOfPage - 2) {
                        ?>
                            <a class="num" style="background-color: #F3F6FA;" href="account_manager_admin.php?pageNow=<?php echo ($numberOfPage); ?>">Last</a>
                        <?php
                        }
                        ?>
                    <?php
