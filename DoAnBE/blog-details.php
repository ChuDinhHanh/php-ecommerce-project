...
$blog = new BlogModel();
$blogDetails = $blog->getBlogById($id);
$listBlogRelated = $blog->getTop3BlogSameAutho($blogDetails['id_account']);
//contact information
...
<body>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-7 order-md-1 order-1">
                    <div class="blog__details__text">
                        ...
                        <img src="img/blog/<?php echo $blogDetails['img_pro']; ?>" alt="">
                        <p>
                            ...
                            <div class="col-lg-6">
                                <div class="blog__details__author">
                                    ...
                                    <div class="blog__details__author__text">
                                        <h6><?php echo $blogDetails['username']; ?></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <section class="related-blog spad">
        <div class="container">
            ...
            <div class="row">
                <?php
                foreach ($listBlogRelated as $value) {
                ?>
